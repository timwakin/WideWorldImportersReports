...
/****** Object:  StoredProcedure [dbo].[sp_SalesByQuarterAndDate]    Script Date: 4/8/2025 12:11:08 PM ******/
SET ANSI_NULLS ON
GO
...
-- =============================================
CREATE PROCEDURE [dbo].[sp_SalesByQuarterAndDate](@StartDate Date = NULL, @EndDate Date = NULL, @ItemName NVarchar(255) = NULL)
AS
BEGIN
SELECT SO.OrderDate
, CASE
